...
PANEL_TPL = ('{"version":"1.0","message_id":"{chat_id}","panels":['
             '{"panel":"right","mode":"external","url":"http://szyg-stq-test.anhuitelecom.com:10001/prod-ai/ops-web/config-workbench.html?offer_id={req_id}&name=&chatId={chat_id}&stage=11&view=workbench","title":"配置工作台"},'
             '{"panel":"right","mode":"external","url":"http://szyg-stq-test.anhuitelecom.com:10001/prod-ai/ops-web/config-workbench.html?offer_id={req_id}&name=&chatId={chat_id}&stage=11&view=stage","title":"审批详情"}]}')
