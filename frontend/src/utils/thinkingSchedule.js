...
export const SCENARIO_SCHEDULES = {
  'chat-generate': [
    { id: 'intent', type: 'llm', title: '意图识别', content: '解析用户输入，识别配置意图' },
  ...
  query: [
    { id: 'intent', type: 'llm', title: '意图识别', content: '解析用户输入，识别检索意图' },
    ...
    { id: 'reply', type: 'llm', title: '整理检索结果', content: '汇总命中方案并生成说明' },
  ],
  'file-parse': [
    { id: 'intent', type: 'llm', title: '意图识别', content: '识别为智读·文件配置映射' },
  ...
  'confirm-batch': [
    { id: 'intent', type: 'llm', title: '意图识别', content: '识别为批量入库闭环' },
    ...
    { id: 'reply', type: 'llm', title: '汇总闭环结果', content: '统计成功与失败项' },
  ],
  compare: [
    { id: 'intent', type: 'llm', title: '意图识别', content: '识别多方案对比意图' },
    { id: 'build', type: 'llm', title: '构建候选方案', content: '准备定价 / 立项对比维度' },
    {
      id: 'ontology',
      type: 'ontology',
      title: '方案评估',
      content: '对比方案并执行合规与收益测算',
    },
    { id: 'reply', type: 'llm', title: '生成推荐结论', content: '输出可解释推荐说明' },
  ],
  'config-trace': [
    { id: 'intent', type: 'llm', title: '意图识别', content: '识别为配置审计追溯' },
  ...
  compliance: [
    { id: 'intent', type: 'llm', title: '意图识别', content: '解析用户输入，确定合规校验目标' },
  ...
  'root-cause': [
    { id: 'intent', type: 'llm', title: '意图识别', content: '解析用户目标与关注指标' },
    { id: 'locate', type: 'llm', title: '锁定异动商品', content: '按渠道 / 促销 / 竞品 / 行为准备下钻' },
    {
      id: 'ontology',
      type: 'ontology',
      title: '原因分析',
    ...
    { id: 'reply', type: 'llm', title: '组织归因说明', content: '汇总主因与证据' },
  ],
  'risk-audit': [
    { id: 'intent', type: 'llm', title: '意图识别', content: '识别为风险稽核' },
    { id: 'scan', type: 'llm', title: '筛查风险规则', content: '匹配适用稽核规则集' },
    {
      id: 'ontology',
      type: 'ontology',
      title: '聚合稽核',
    ...
    { id: 'reply', type: 'llm', title: '组织稽核结论', content: '输出风险清单与建议' },
  ],
}
