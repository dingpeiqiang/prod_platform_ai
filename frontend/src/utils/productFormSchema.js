/**
 * 产品配置表单 schema 生成器与字段工具
 *
 * 由 productMockData.js 重构而来：演示数据（mockProducts/scene2Products/SKILL_CONFIG/CAMPUS_PRODUCT_DATA）
 * 已随 mock 清理删除，本文件仅保留与后端表单渲染对接的工具函数，无任何业务 mock。
 */
