...
public final class EvalToolStubs {
    ...
    public static List<AgentTool> all() {
        return List.of(
                ...
                stub("rd_category_resolve", "识别产品品类", Set.of("rd"),
                        List.of(param("text", "配置需求", true),
                                param("product_type", "产品品类", false))),
                stub("rd_draft_generate", "对话生成配置草稿", Set.of("rd"),
                        List.of(param("text", "配置需求", true),
                                param("draft", "已有草稿", false))),
                stub("rd_config_search", "检索历史配置", Set.of("rd"),
                ...
                stub("rd_doc_parse", "文档解析", Set.of("rd"), List.of()),
                stub("rd_draft_extract", "套餐抽取", Set.of("rd"), List.of()),
                stub("rd_workorder_create", "批量落库开单", Set.of("rd"), List.of()),
