...
CREATE TABLE `pd_ai_chat_sessions` (
    ...
    ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='聊天会话表' DISTRIBUTED BY DUPLICATE(g1,g2);
...
CREATE TABLE `pd_ai_mcp_tool_definitions` (
    ...
    ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='MCP工具定义表' DISTRIBUTED BY DUPLICATE(g1,g2);
...
CREATE TABLE `pd_ai_mcp_call_logs` (
    ...
    ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='MCP工具调用日志表' DISTRIBUTED BY DUPLICATE(g1,g2);
...
CREATE TABLE `pd_ai_mcp_tool_stats` (
    ...
    ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='MCP工具聚合统计表' DISTRIBUTED BY DUPLICATE(g1,g2);
...
CREATE TABLE `pd_ai_llm_user_configs` (
    ...
    ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='用户LLM配置表' DISTRIBUTED BY DUPLICATE(g1,g2);
...
CREATE TABLE `pd_ai_prompts` (
    ...
    ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='提示词主表' DISTRIBUTED BY DUPLICATE(g1,g2);
...
CREATE TABLE `pd_ai_prompt_templates` (
    ...
    ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='提示词预设模板库' DISTRIBUTED BY DUPLICATE(g1,g2);
...
CREATE TABLE `pd_ai_workflows` (
    ...
    ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='工作流主表' DISTRIBUTED BY DUPLICATE(g1,g2);
...
CREATE TABLE `pd_ai_traces` (
    ...
    ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='追踪记录' DISTRIBUTED BY DUPLICATE(g1,g2);
...
CREATE TABLE `pd_ai_ontology_instance` (
    ...
    ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='本体实例主表' DISTRIBUTED BY DUPLICATE(g1,g2);
...
CREATE TABLE `pd_ai_ontology_version` (
    ...
    ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='本体资产版本主表' DISTRIBUTED BY DUPLICATE(g1,g2);
...
CREATE TABLE `pd_ai_ontology_version_log` (
    ...
    ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='本体资产版本动作日志（审计一张表）' DISTRIBUTED BY DUPLICATE(g1,g2);
...
-- ------------------------------------------------------------
-- 用户认证表（对齐 classpath:sql/h2/schema-h2.sql 与 goldendb/01）
-- 初始账号种子见 02_init_data.sql §6
-- ------------------------------------------------------------
...
CREATE TABLE `pd_ai_swrl_rules` (
    ...
    ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='条件DSL规则表（非OWL SWRL）' DISTRIBUTED BY DUPLICATE(g1,g2);
...
CREATE TABLE `pd_ai_api_saved_request` (
    ...
    ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='接口管理·已保存请求（请求集合条目）' DISTRIBUTED BY DUPLICATE(g1,g2);
...
CREATE TABLE `pd_ai_api_request_history` (
    ...
    ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='接口管理·请求历史' DISTRIBUTED BY DUPLICATE(g1,g2);
